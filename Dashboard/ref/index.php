			...
			echo '<td valign="top">';
				...
				while ($row = mssql_fetch_assoc($data)){
					...
					if (isset($row['BirthDate'])) {
						$row['BirthDate'] = date_format(date_create_from_format('m d Y  H:ia', $row['BirthDate']), 'Y-m-d H:i:s');
					}
					if (isset($row['WHUpdateTime'])) {
						$row['WHUpdateTime'] = date_format(date_create_from_format('m d Y  H:ia', $row['WHUpdateTime']), 'Y-m-d H:i:s');
					}
					if (isset($row['HandoverTime'])) {
						$row['HandoverTime'] = date_format(date_create_from_format('m d Y  H:ia', $row['HandoverTime']), 'Y-m-d H:i:s');
					}
					if (isset($row['PGITime'])) {
						$row['PGITime'] = date_format(date_create_from_format('m d Y  H:ia', $row['PGITime']), 'Y-m-d H:i:s');
					}
