...
$strArray = array();
$arr = array('Runin_End','Check_In','Check_Out');
$data = array();
...
$url = 'http://16.187.224.112:8080/Yi/FEDeck/';
$message .= "<a href=".$url.">click here for details of order status</a>";
